...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Admin\\Desktop\\bhaktiexperiment\\untitled_lastrun.py',
...
image = visual.ImageStim(
    ...
    ori=0.0, pos=(0, 0.3), size=(0.1, 0.1),
...
for thisTrial in trials:
    ...
    trialComponents = [polygon, text, key_resp, image, polygon_2]
    ...
    elif key_resp.keys == 'm' and is_match:  # Correct match response
        feedback_message = 'Correct'
    elif key_resp.keys == 'n' and not is_match:  # Correct not-match response
        feedback_message = 'Correct'
    else:  # Any other response is incorrect
        feedback_message = 'Incorrect'
       
    is_match = int(is_match)  # is_match is now treated as a variable from the Excel file
    
    text_2.setText(feedback_message)
    # keep track of which components have finished
